package net.flo.stargaze.block;
...
public class ModBlocks {
    ...
    private static Item registerBlockItem(String name, Block block){
        return Registry.register(Registries.ITEM, new Identifier(Stargaze.MOD_ID, name),
                new BlockItem(block, new FabricItemSettings()));
    }
    public static void registerModBlocks() {
        Stargaze.LOGGER.info("Registering ModBlocks for" + Stargaze.MOD_ID);
    }
}
